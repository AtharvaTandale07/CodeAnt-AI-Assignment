...
//           />
//         </div>
//         <div className='w-full lg:w-1/2 bg-[#FAFAFA] flex justify-center items-center'>
//           <div className='bg-white rounded-lg w-11/12 h-[67%] drop-shadow-lg'>
//             <SignupContent />
//             <div className='text-center'>By signing up you agree to the <span className='font-semibold'>Privacy Policy</span></div>
//           </div>
//         </div>
//       </div>
//     </div>
